...
A small desktop app for testing your PC's hardware: microphones, headphones/speakers, and your keyboard. Windows' built-in troubleshooting for these is unreliable, and testing them online usually means hunting down a sketchy website. Trouble runs locally instead.

Built with Tauri, React, and TypeScript on the frontend, with the hardware logic (audio I/O, keyboard state) handled in Rust.
...
| Mouse test (planned)   | Clicks, movement, scroll                                                          |
